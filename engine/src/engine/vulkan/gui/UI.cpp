...
namespace Spyder::Vulkan {
	UI::UI(Instance &instance, Device &device, SwapChain &swapChain, Window &window, CommandPool &commandPool) : r_Instance{instance}, r_Device{device}, r_SwapChain{swapChain}, r_Window{window}, r_CommandPool{commandPool} {}
	...
	void UI::init() {
		...
		ImGui_ImplGlfw_InitForVulkan(r_Window.getWindow(), true);
		...
		ImGui_ImplVulkan_Init(&init_info, r_SwapChain.getRenderPass());

		auto cmd = r_CommandPool.beginSingleTimeCommands();
		ImGui_ImplVulkan_CreateFontsTexture(cmd);
		r_CommandPool.endSingleTimeCommands(cmd);
